...
while hp>0:
    ...
    place = input("(L(leave) or S(shelter))")
    ...
    print("Right before you go to sleep you hear rustling behind you. Do you try to make yourself look big and intimidating, or do you run away?")
    animal = input("(B or R)")
    if animal== "B":
